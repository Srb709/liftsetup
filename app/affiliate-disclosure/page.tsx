    ...
    <div className="py-14">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="flex items-center gap-2 text-xs text-zinc-400 mb-8">
          ...
          <span>/</span>
          <span className="text-zinc-600">Affiliate Disclosure</span>
        </nav>

        <div className="mb-10">
          <h1 className="text-3xl font-bold text-zinc-900 leading-tight">Affiliate Disclosure</h1>
          <p className="text-sm text-zinc-400 mt-2">Last updated: April 23, 2026</p>
        </div>

        <div className="space-y-8 text-zinc-600 text-sm leading-relaxed">
          <section className="p-5 bg-accent-50 border border-accent-100 rounded-xl">
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Amazon Associates Program</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">How affiliate links work</h2>
            <p>
            ...
            <p className="mt-2">
              ...
              <code className="px-1 py-0.5 bg-zinc-100 rounded text-xs font-mono">tag=liftsetup-20</code> parameter in
              Amazon URLs. You are never required to use these links.
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">How this affects our recommendations</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">FTC compliance</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Questions</h2>
            <p>
