  ...
  return (
    <div className="py-14">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          <span className="text-xs font-semibold text-accent-600 uppercase tracking-widest">About LiftSetup</span>
          <h1 className="text-3xl sm:text-4xl font-bold text-zinc-900 mt-2 leading-tight">
            We help people build better home gyms.
          </h1>
        </div>

        <div className="prose-content space-y-8 text-zinc-600 leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">Why we built this</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">What we focus on</h2>
            <p className="text-base">
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">How our recommendations work</h2>
            <p className="text-base">
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">Affiliate links</h2>
            <p className="text-base">
            ...
            <p className="text-base mt-3">
              ...
              <Link href="/affiliate-disclosure" className="text-accent-600 hover:text-accent-700 underline">
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">What we do not do</h2>
          ...
          <div className="pt-4 border-t border-zinc-200">
            ...
            <div className="mt-6 flex gap-4">
              <Link
                href="/guides"
                className="inline-flex items-center px-5 py-2.5 bg-accent-600 text-white text-sm font-semibold rounded-lg hover:bg-accent-700 transition-colors"
              >
                Browse Guides
              </Link>
              <Link
                href="/categories"
                className="inline-flex items-center px-5 py-2.5 bg-white text-zinc-700 text-sm font-semibold rounded-lg border border-zinc-200 hover:border-zinc-300 hover:bg-zinc-50 transition-colors"
              >
                Browse Equipment
              </Link>
            </div>
