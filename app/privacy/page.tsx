  ...
  return (
    <div className="py-14">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-zinc-900 leading-tight">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-zinc-600 text-sm leading-relaxed">
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Overview</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Information collected automatically</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Analytics</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Third-party links</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Affiliate links</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Children</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-zinc-900 mb-2">Changes to this policy</h2>
            <p>
